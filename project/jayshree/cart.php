...
<?php
    ...
    if(isset($_POST['remove']))
    {
        ...
        $sql="delete from cart_tbl where Ct_P_Code='$Ct_P_Code' ";
...
<?php
    ...
    // $sql = "select * from product_tbl where P_Code in (select Ct_P_Code from cart_tbl where U_Email_Id='$U_Email_Id')";

    $sql="select * from product_tbl P INNER JOIN category_tbl C on P.P_C_Code=C.C_Code where P_Code in (select Ct_P_Code from cart_tbl where U_Email_Id='$U_Email_Id')";
    ...
    if(mysqli_num_rows($data))
    {
        ...
        {
            $P_Total_Price=$result['P_Total_Price'];
?>
                ...
                <div class='col-lg-7 mt-5'>
                    <div class='card'>
                        <div class='card-body'>
                            ...
                            <!--total of cart-->
                            <?php $sum_cart=$sum_cart+$P_Total_Price; ?>
                        ...
                        <form method="POST">   
                            ...
                            <div class='col d-grid'>
                                    <input type='submit' name='remove' value="Remove" class='btn btn-success btn-lg' />
                                </div>
                                <div class='col d-grid'>
...
<!-- <h2 style="display: -webkit-box;
    ...
    box-sizing: border-box;">Total of Cart : <?php echo $sum_cart; ?></h2> -->
    <!-- Close Content -->
