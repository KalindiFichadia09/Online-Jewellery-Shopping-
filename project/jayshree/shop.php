...
<?php
    ...
    if(mysqli_num_rows($data))
    {
        while($result=mysqli_fetch_array($data))
        {
            echo "
                    <li class='nav-item'>
                        <a class='nav-link' href='shop1.php?C_Code=".$result['C_Code']."'>".$result['C_Name']."</a>
                    </li>
                        ...
                        <ul class="collapse show list-unstyled pl-3">
                            <?php
                                ...
                                if(mysqli_num_rows($data))
                                {
                                    ...
                                    {
                                        echo "
                                            <!--<li><a class='text-decoration-none' href='#'>Male</a></li>
                                            <li><a class='text-decoration-none' href='#'>Female</a></li>-->
                                            ";
                                    }
                                }
                                else
                        ...
                        <ul id="collapseThree" class="">
                            <?php
                                ...
                                if(mysqli_num_rows($data))
                                {
                                    ...
                                    {
                                        echo '
                                            <li class="nav-item"><a class="text-decoration-none" href="#" >'.$result['P_Name'].'</a></li>
                                        ';
                                    }
                                }
                            ?>
                    ...
                    <div class='col-md-4'>
                        <div class='card mb-4 product-wap rounded-0'>
                            <div class='card rounded-0'>
                                <img class='card-img rounded-0 img-fluid' src=".$result['P_Image'].">
                                <div class='card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center'>
                                    <ul class='list-unstyled'>
                                        <li><a class='btn btn-success text-white' href='wishlist.php?P_Code=".$result['P_Code']."'><i class='far fa-heart'></i></a></li>
                                        <li><a class='btn btn-success text-white mt-2' href='shop_single.php?P_Code=".$result['P_Code']."'><i class='far fa-eye'></i></a></li>
                                        <li><a class='btn btn-success text-white mt-2' href='cart.php?P_Code=".$result['P_Code']."'><i class='fas fa-cart-plus'></i></a></li>
                                    </ul>
                                </div>
                            </div>
                            <div class='card-body'>
                                <a href='shop_single.php?P_Code=".$result['P_Code']." ' class='h3 text-decoration-none '>".$result['P_Name']."</a>
                                <ul class='w-100 list-unstyled d-flex justify-content-between mb-0'>
                                
                                </ul>
                                <p class='text-center mb-0'>Rs.".$result['P_Total_Price']."</p>
                            </div>
                        </div>
                    </div>";
            }
