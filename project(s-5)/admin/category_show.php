          ...
          <div class="templatemo-flex-row flex-content-row">
            <div class="col-1">              
              <div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
                <div class="panel-heading templatemo-position-relative"><h2 class="text-uppercase">Category Table</h2></div>
            ...
            echo "
                <tbody>
                    <tr>
                        ...
                        <td>".$result['C_Name']."</td>
                        <td>".$result['C_Type']."</td>
                        <td>".$result['C_Image']."</td>
                        <td><a href='category_update.php?C_Id=$result[C_Id] &C_Code=$result[C_Code] &C_Name=$result[C_Name] &C_Type=$result[C_Type]&C_Image=$result[C_Image]'>Update</a></td>
						            <td><a href='category_delete.php?C_Id=$result[C_Id]'>Delete</a></td>
                    </tr>
                </tbody>
