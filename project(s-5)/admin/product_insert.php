...
<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        {
          $sql="insert into product_tbl values('P_Id','$P_Code','$P_Name','$P_C_Code','$P_Type','$P_Gross_Weight','$P_Diamond_Weight','$P_Diamond_Pices','$P_Purity','$P_Gold_Weight','$P_Gold_Price','$P_Diamond_Price','$P_Making_Charge','$P_Overhead','$P_Base_Price','$P_Tax','$P_Total_Price','$P_Diamond_Color','$P_Stock','$file_store')";
            ...
            <form action="" class="templatemo-login-form" method="post" enctype="multipart/form-data">
                <div class="row form-group">
                    <div class="col-lg-6 col-md-6 form-group">                  
                        ...
                        <input type="text" name="P_Code" placeholder="Enter product code" required>                  
                    </div>
                    <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <!-- <div class="col-lg-6 col-md-6 form-group">                  
                        <label for="inputLastName">Product Total Price</label><br/>
                        <input type="text" name="P_Total_Price" placeholder="Enter product price" required>                  
                    </div> -->
                    <div class="col-lg-6 col-md-6 form-group">                  
                        <label for="inputLastName">Product Gross Weight</label><br/>
                        <input type="text" name="P_Gross_Weight" placeholder="Enter product weight" required>                  
                    </div>
                    <div class="col-lg-6 col-md-6 form-group">                  
                        <label for="inputLastName">Product Diamond Weight</label><br/>
                        <input type="text" name="P_Diamond_Weight" placeholder="Enter product diamond weight" required>                  
                    </div>
                    <div class="col-lg-6 col-md-6 form-group">                  
                        <label for="inputLastName">Product Diamond Pices</label><br/>
                        <input type="text" name="P_Diamond_Pices" placeholder="Enter product Diamond Pices" required>                  
                    </div>
                    <div class="col-lg-6 col-md-6 form-group">                  
                        <label for="inputLastName">Product Overhead Charges</label><br/>
                        <input type="text" name="P_Overhead" placeholder="Enter product overhead charges" required>                  
                    </div>  
                    <div class="col-lg-6 col-md-6 form-group">                  
                      <label for="inputLastName">Product Purity</label><br/>
                      <select name="P_Purity" placeholder="select" required>
                        <option>22 karat (91.67% Gold)</option>
                        <option>20 karat (83.3% Gold)</option>
                        <option>18 karat (75% Gold)</option>
                        <option>16 karat (66.7% Gold)</option>
                        <option>14 karat (58.3% Gold)</option>
                      </select>                
                    </div>
                    <!-- <div class="col-lg-6 col-md-6 form-group">                  
                        <label for="inputLastName">Product Size</label><br/>
                        <input type="text" name="P_Size" placeholder="Enter product size" required>                  
                    </div> -->
                    <div class="col-lg-6 col-md-6 form-group">                  
                        <label for="inputLastName">Product Diamond Color</label><br/>
                        <input type="text" name="P_Diamond_Color" placeholder="Enter product diamond color" required>                  
                    </div>
                    <div class="col-lg-6 col-md-6 form-group">                  
                        <label for="inputLastName">Product Stock</label><br/>
                        <input type="text" name="P_Stock" placeholder="Enter product stock" required>                  
                    </div>
                    <div class="col-lg-12">
