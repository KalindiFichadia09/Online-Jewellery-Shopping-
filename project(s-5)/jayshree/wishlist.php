...
include '../conn.php';
    if(isset($_POST['remove']))
    {
        ...
        $sql="delete from wishlist_tbl where W_P_Code='$W_P_Code' ";
...
<?php
    ...
    include '../conn.php';
    $U_Email_Id=$_SESSION['U_Email_Id'];
    // $sql = "select * from product_tbl where P_Code in (select W_P_Code from wishlist_tbl where U_Email_Id='$U_Email_Id')";
    // join user_tbl on P_Code=W_P_Code where U_Email_Id='$U_Email_Id'";
    $sql="select * from product_tbl P INNER JOIN category_tbl C on P.P_C_Code=C.C_Code where P_Code in (select W_P_Code from wishlist_tbl where U_Email_Id='$U_Email_Id')";
    $data = mysqli_query($con,$sql);
