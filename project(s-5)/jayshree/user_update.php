...
<div class="m_margin"></div>
    <div class="mdiv">
		...
		<tr>
            <td>Gender :</td>
            <td><input type="radio" name="U_Gender" value="male" 
                        <?php
		...
		<tr>
            <td>Email Id :</td>
            <td><input type="email" name="U_Email_Id" value="<?php echo $row['U_Email_Id'];?>"/></td>
        </tr>
		<tr>
        	<td>Phone no :</td>
            <td><input type="tel" name="U_Phone_no" value="<?php echo $row['U_Phone_no'];?>"/></td>
        </tr>
	</table>
</div>
...
<div class="mdiv">
    <h2>Address Information</h2>
        ...
        <table>
            <tr>
                <td>Address :</td>
                <td><input type="text" name="U_Address" value="<?php echo $row['U_Address'];?>"/></td>
            </tr>
			<tr>
                <td>City :</td>
                <td><input type="text" name="U_City" value="<?php echo $row['U_City'];?>"/></td>
            </tr>
			<tr>
                <td>Pincode :</td>
                <td><input type="pincode" name="U_Pincode" value="<?php echo $row['U_Pincode'];?>"></td>
            </tr>
			<tr>
                <td>State :</td>
                <td><input type="text" name="U_State" value="<?php echo $row['U_State'];?>"/></td>
            </tr>
			<tr>
                <td>Country :</td>
                <td><input type="text" name="U_Country" value="<?php echo $row['U_Country'];?>"/></td>
            </tr>
			<tr>
                <td>Password :</td>
                <td><input type="password" name="U_Password" placeholder="Enter Password" required></td>
            </tr>
		</table>
    </div>
</div>
