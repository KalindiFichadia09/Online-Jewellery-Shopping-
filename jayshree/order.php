...
if(isset($_POST['remove']))
{
    ...
    $sql="delete from order_tbl where O_P_Code='$O_P_Code' ";
...
if(isset($_POST['checkout']))
{
    ...
    $sql="insert into order_tbl values('O_Id','$O_P_Code','$U_Email_Id')";
    $data=mysqli_query($con,$sql);
...
<?php
    ...
    include '../conn.php';
    $U_Email_Id=$_SESSION['U_Email_Id'];
    $sql = "select * from product_tbl where P_Code in (select O_P_Code from order_tbl where U_Email_Id='$U_Email_Id')";
                    ...
                    <div class='card'>
                        <div class='card-body'>
                            ...
                            <ul class='list-inline'>
                                ...
                                <li class='list-inline-item'>
                                    <p class='text-muted'><strong><?php echo "$result[P_Category_Type]";?></strong></p>
                                </li>
                            </ul>
                        ...
                        <form method="POST">   
                            ...
                            <div class='col d-grid'>
                                ...
                                <div class='col d-grid'>
                                    <input type="submit" name="checkout" value="Process To Checkout" class='btn btn-success btn-lg' />
                                </div>
                            </div>
                        </form>
