    ...
    <div id="template-mo-zay-hero-carousel" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <div class="row">
                    <img style="max-width: 100%; height: auto;" src="./assets/img/fp1.png" alt="">
                </div>
            </div>
            <div class="carousel-item">
                <div class="row">
                    <img style="max-width: 100%; height: auto;" class="" src="./assets/img/fp2.png" alt="">
                </div>
            </div>
            <div class="carousel-item">
                <div class="row">
                    <img style="max-width: 100%; height: auto;" src="./assets/img/fp3.png" alt="">
                </div>
            </div>
        </div>
                    ...
                    <div class="row p-5">
                        ...
                        <div class="col-lg-6 mb-0 d-flex align-items-center">
                            <div class="text-align-left align-self-center">
                                <h1 class="h1 text-success"><b>Jayshree</b> Jewels</h1>
    ...
    <section class="container py-5">
        <div class="row text-center pt-3">
            <div class="col-lg-6 m-auto">
                <h1 class="h1"><i>Categories</i></h1><!--of The Month-->
                <!-- <p>
		    ...
		    while($result=mysqli_fetch_array($data))
		    {
			    echo "
                        <div class='col-12 col-md-4 p-5 mt-3'
                            <a href='shop.php'>
                            <img src=".$result['C_Image']." class='rounded-circle img-fluid border'></a>
                            <h5 class='text-center mt-3 mb-3'>".$result['C_Name']."</h5>
...
<section class="bg-light">
        <div class="container py-5">
            ...
            <?php
                ...
                include '../conn.php';
                // $U_Email_Id=$_SESSION['U_Email_Id'];
                $sql = "select * from product_tbl order by P_Code desc limit 3 ";
                // join user_tbl on P_Code=W_P_Code where U_Email_Id='$U_Email_Id'";
                $data = mysqli_query($con,$sql);
                //$total = mysqli_num_rows($data);
            ...
            echo '
                <div class="col-12 col-md-4 mb-4">
                    <div class="card h-100">
                        <a href="shop-single.php?P_Code='.$result['P_Code'].'">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                ...
                                <a href=" " class="h2 text-decoration-none text-dark"> '.$result['P_Name'].' </a>
                                <li class="text-muted text-right"> Rs. '.$result['P_Total_Price'].'</li>
                            </ul>
    ...
    <section class="bg-light">
        <div class="container py-5">
            ...
            <?php
                ...
                include '../conn.php';
                // $U_Email_Id=$_SESSION['U_Email_Id'];
                $sql = "select * from product_tbl join order_detail_tbl on P_Code=O_P_Code group by P_Code order by count(O_P_Code) desc limit 3 ";
                // join user_tbl on P_Code=W_P_Code where U_Email_Id='$U_Email_Id'";
                $data = mysqli_query($con,$sql);
                //$total = mysqli_num_rows($data);
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            <ul class="list-unstyled d-flex justify-content-between">
                                ...
                                <a href="shop-single.php" class="h2 text-decoration-none text-dark"> '.$result['P_Name'].' </a>
                                <li class="text-muted text-right"> Rs. '.$result['P_Total_Price'].'</li>
                            </ul>
