      ...
      include '../conn.php';
        ...
        if(isset($_POST['submit']))
        {
          ...
          $file_store="../img/".$file_name;
            ...
            {
              $sql="insert into Category_tbl values('C_Id','$C_Code','$C_Name','$C_Type','$file_store')";
          ...
          <div class="row">
            <nav class="templatemo-top-nav col-lg-12 col-md-12">
              <ul class="text-uppercase">
                ...
                <li><a href="category_insert.php">Category insert</a></li>
              </ul>
            </nav>
          </div>
        </div>
            ...
            <form action="" class="templatemo-login-form" method="post" enctype="multipart/form-data">
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <input type="text" name="C_Code" placeholder="Enter category code" required>                  
                </div>
                <div class="col-lg-6 col-md-6 form-group">                  
              ...
              <label for="inputLastName">Category Type</label><br/>                  
