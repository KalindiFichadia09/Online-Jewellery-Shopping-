                  ...
                  <table class="table table-striped table-bordered">
                    <thead>
                        <tr>
                            ...
                            <td>Order Total Gross Weight</td>
                            <td>Order Product Type  </td>
                            <td>Order Product Purity</td>
                            <td>Order Product Quentity</td>
                            <td>Order Date</td>
                            <td>Full Name</td>
                            <td>Email Id</td>
                            <td>Mobile</td>
                    ...
                    <?php
	include '../conn.php';
	$sql = "select * from order_detail_tbl";						
        ...
        while($result=mysqli_fetch_array($data))
        {
            echo "
                <tbody>
                    <tr>
                        <td>".$result['O_Id']."</td>
                        <td>".$result['O_P_Code']."</td>
                        <td>".$result['O_P_Name']."</td>
                        <td>".$result['O_Total_Price']."</td>
                        <td>".$result['O_P_Gross_Weight']."</td>
                        <td>".$result['O_P_Type']."</td>
                        <td>".$result['O_P_Purity']."</td>
                        <td>".$result['O_Quentity']."</td>
                        <td>".$result['O_Date']."</td>
                        <td>".$result['O_U_Name']."</td>
                        <td>".$result['O_U_Email_Id']."</td>
                        <td>".$result['O_Phone_no']."</td>
                        <td>".$result['O_Shipping_Address']."</td>
                        <td>".$result['O_City']."</td>
                        <td>".$result['O_Pincode']."</td>
                        <td>".$result['O_State']."</td>
                        <td>".$result['O_Country']."</td>
                    </tr>
                </tbody>
